...
function download() {
    ...
    allData.push('', '');
    allData.push(['I. Antemortems Inspection', '', '', '', '', '', '']); // Name for Antemortems Inspection
    allData = allData.concat(getVisibleTableData('tableOne', 'A. Receiving of Food Animals for Slaughter'));
    allData = allData.concat(getVisibleTableData('tableTwo', 'B. Conduct of Antemortems Inspection'));
    ...
    // Create a merged cell for "Antemortems Inspection"
